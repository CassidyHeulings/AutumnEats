...
function Menu() {
  ...
  return (
    <div className="menu">
      ...
      <br />
      <p className='menu_items'>Appetizer</p>
      <button
      ...
      <br />
      <p className='menu_items'>First Course</p>
      <button
      ...
      <br />
      <p className='menu_items'>Main Course</p>
      <button
      ...
      <br />
      <p className='menu_items'>Desserts</p>
      <button
